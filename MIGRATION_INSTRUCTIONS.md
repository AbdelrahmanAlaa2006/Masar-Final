...
- **مسار الملف في المشروع**:
  ...
  [`backend/migrations/2026_09_07_exam_hourly_availability.sql`](file:///c:/Work/alaaaaaa/Masar-Final/backend/migrations/2026_09_07_exam_hourly_availability.sql)
...
2. إضافة وتحديث trigger `compute_exam_expiration` لحساب `expires_at` بدقة عند اختيار المدة بالساعات أو بالأيام وتصفيره عند عدم توفر المدخلات.
