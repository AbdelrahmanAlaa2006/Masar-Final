    ...
    <main className="pp-page" dir="rtl">
      <div className="pp-container">
        ...
        <div className="pp-hero">
          ...
          <p>دليل مختصر يساعدك في الاستفادة الكاملة من منصة {tenant?.name || 'GitFekra'}، مع إجابات للأسئلة الأكثر تكراراً من الطلاب.</p>
        </div>

        <div className="pp-card">
          <h2><span className="pp-num"><i className="fas fa-book"></i></span> ابدأ من هنا</h2>
          <p>{tenant?.name || 'GitFekra'} تتيح لك المحاضرات، الفيديوهات التعليمية، والامتحانات الإلكترونية لمرحلتك الدراسية. الخطوات الأساسية:</p>
          <ul>
