                ...
                <div className="home-modules-grid">
                  {(() => {
                    const visibleCards = [
                      ...
                      { key: 'lectures', route: '/lectures', icon: <VideosIcon />, label: 'المحاضرات', descAdmin: 'إدارة المحاضرات وضبط صلاحيات المشاهدة', descStudent: 'متابعة المحاضرات والدروس التعليمية' },
