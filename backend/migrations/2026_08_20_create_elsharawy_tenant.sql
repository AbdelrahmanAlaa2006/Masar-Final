-- ============================================================================
-- 2026_08_20_create_elsharawy_tenant.sql
--
-- Creates the dedicated tenant for أ. الشعراوي (صانع الأبطال)
-- Slug: `elsharawy`
-- Colors: Gold #a86e28 + deep teal #175e54 on cream / petrol (same as eldad)
-- Stages: Primary stage ONLY (different subjects)
-- Logo: /images/Elshaarawy Logo.png
-- Teacher Image: /images/ELshaarawy Teacher Image.png
-- ============================================================================
...
VALUES (
  ...
  jsonb_build_object(
    ...
    'branding', jsonb_build_object(
      ...
      'description', 'منصة أستاذ الشعراوي صانع الأبطال لتدريس مختلف مواد المرحلة الابتدائية وتأسيس الطلاب لجميع الصفوف الابتدائية.'
    ),
