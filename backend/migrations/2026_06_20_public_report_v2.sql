-- =====================================================================
-- Public Secure Student Report & WhatsApp Notification RPC Functions - Version 2
-- Run in Supabase SQL Editor to allow unauthenticated parent lookups.
-- =====================================================================

-- 1. Function to retrieve complete report after verifying qr_token and phone number (includes payments and class averages)
...
BEGIN
  ...
  FROM (
    SELECT id, amount, status, package_name, payment_method, created_at
