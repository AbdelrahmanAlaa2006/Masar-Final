...
export const DOMAINS = {
  ...
  'mohamed-abdella': {
    ...
    description:
      'منصة باور التعليمية لمستر محمد عبداللاه (Mr Mohamed Abdella) — شرح البرمجة والذكاء الاصطناعي وعلوم الحاسب للمراحل الإعدادية والثانوية ونظام البكالوريا المصرية الجديد. تعليم أونلاين تفاعلي، متابعة الطلاب، امتحانات إلكترونية وتقارير ولي الأمر.',
    keywords:
  ...
  eldad: {
    ...
    description:
      'منصة الضاد للأستاذ خالد الشريف — شرح اللغة العربية لطلاب نظام البكالوريا المصرية الجديد. النحو والبلاغة والأدب والنصوص وفق مواصفات البكالوريا، بأسلوب مبسّط وحديث مع امتحانات إلكترونية على نمط البكالوريا ومتابعة دقيقة لأداء كل طالب.',
    keywords:
